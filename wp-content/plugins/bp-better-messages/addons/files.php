        ...
        public function upload_form( $thread_id )
        {
            ...
            <script type="text/javascript">
                ...
                function insertButton() {
                    ...
                    <?php if( $thread_id === 0 ){ ?>
                    var selector = '.bp-messages-wrap.bp-messages-wrap-main .new-message .bp-emojionearea, .bp-messages-wrap#bp-better-messages-mini-mobile-container .new-message .bp-emojionearea';
                    ...
                    <?php } else { ?>
                    var selector = '.bp-messages-wrap.bp-messages-wrap-main .reply form .message, .bp-messages-wrap#bp-better-messages-mini-mobile-container .reply form .message, .bp-messages-wrap.bp-better-messages-mini .chat[data-thread="<?php echo $thread_id; ?>"] .reply form .message .bp-emojionearea';
                    var button   = '<span id="bpbm-upload-btn-<?php echo $thread_id; ?>" class="upload-btn"><i class="fas fa-paperclip" aria-hidden="true"></i><span class="count count-' + count + '">' + count + '</span></span>';
                    <?php } ?>

                    var initiated = $(selector).prepend(button);
