...
class BP_Better_Messages_Options
{
    ...
    public function update_settings( $settings )
    {
        ...
        if( ! isset($settings['disableTapToOpen']) )   $settings[ 'disableTapToOpen' ] = '0';
        if( ! isset($settings['mobileFullScreen']) )   $settings[ 'mobileFullScreen' ] = '0';
        ...
        if( ! isset($settings['replaceStandardEmail']) ) $settings[ 'replaceStandardEmail' ] = '0';
        if( ! isset($settings['mobilePopup']) ) $settings[ 'mobilePopup' ] = '0';
        if( ! isset($settings['autoFullScreen']) ) $settings[ 'autoFullScreen' ] = '0';
