        ...
        <div class="bpbm-user-options">
            ...
            <div class="bpbm-user-option">
                <div class="bpbm-user-option-toggle">
                    <input id="email_notifications" type="checkbox" value="1">
                ...
                <div class="bpbm-user-option-description">
                    <?php esc_attr_e('When enabled, you will receive notifications about new messages via email when you offline.', 'bp-better-messages'); ?>
                </div>
            </div>
