...
if (is_admin() === true) {
    ...
    function duplicator_pro_plugins_loaded()
    {
        ...
        try {
            ...
            DUP_PRO_LOG::traceError("Could not do data initialization.");
        }
    }
...
() {
        ...
        wp_localize_script('dup-pro-global-script', 
            ...
            array(
                'dismiss_plugin_activation_admin_notice_nonce' => wp_create_nonce('duplicator_pro_dismiss_plugin_activation_admin_notice'),
            )
        );
    }
