...
jQuery(document).ready(function () {
    ...
    //@P ---- global settings -----
    //class="elementor-control elementor-control-dce_smoothtransition_class_controller elementor-control-type-hidden elementor-label-inline elementor-control-separator-default"
    ...
    var detect_contet_frame = function ($content) {
        ...
        if (isSelectorValid($content) && typeof $content !== "undefined") {
            ...
            if (countSelectorValid >= sectorListLength) {
                ...
                //jQuery(".elementor-control-dce_smoothtransition_class_controller input").trigger('input');
            } else {
