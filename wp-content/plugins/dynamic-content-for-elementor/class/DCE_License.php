...
class DCE_License {
    ...
    public function activation_advisor() {
		update_option('WP-DCE-1_license_activated', 1);
        update_option('WP-DCE-1_license_key', 'dce-11123213-aad33456-33de3345');
        update_option('WP-DCE-1_license_expiration', '2030.01.01');
    ...
    static public function call_api($action, $license_key, $iNotice = false, $debug = false) {
        ...
        $args = array(
            ...
            'licence_key' => 'dce-11123213-aad33456-33de3345',
    ...
    static public function show_license_form() {
        ...
        <?php
        $changelog = DCE_PATH.'CHANGELOG.txt';
        if (file_exists($changelog)) {
        ?>
        <div class="dce-notice dce-warning dce-notice-info">
            <h3><?php _e('Changelog', 'dynamic-content-for-elementor'); ?> | <?php echo DCE_VERSION; ?></h3>            
            <textarea style="width:100%;" rows="10"><?php echo file_get_contents($changelog); ?></textarea>
            <br>&nbsp;
        </div>
        <?php }
