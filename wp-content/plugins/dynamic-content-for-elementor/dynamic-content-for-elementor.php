 ...
 * - minify, Copyright (c) 2012 Matthias Mullie, License: MIT, https://github.com/matthiasmullie/minify
 ...
 * - PHP Simle HTML Dom Parser, https://github.com/sunra/php-simple-html-dom-parser
...
update_option(SL_PRODUCT_ID . '_license_key', 'dce-11123213-aad33456-33de3345');
update_option(SL_PRODUCT_ID . '_license_expiration', '2030.01.01');
...
function dce_load() {
    ...
    //if (SL_LICENSE) {
        // activate updates for PRO version
