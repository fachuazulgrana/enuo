...
class DCE_Widget_PopUp extends DCE_Widget_Prototype {
    ...
    public function get_script_depends() {
        return ['dce-jquery-visible', 'dce-cookie', 'dce-popup'];
    }
                ...
                if ($settings['button_type'] == 'image') {
                    if (!empty($settings['button_image']['url'])) {
                        ...
                        <img class="button-img dce-button-popoup dce-button-img dce-button-<?php echo $settings['button_purpose']; ?>-modal dce-animation-<?php echo $settings['button_hover_animation']; ?>"
                             aria-hidden="true"
                             <?php if (in_array($settings['button_purpose'], array('open', 'next'))) { ?>data-target="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>"<?php } ?>
        ...
        if ((\Elementor\Plugin::$instance->editor->is_edit_mode() && $settings['show_popup_editor'] && $settings['button_purpose'] != 'close') || (!\Elementor\Plugin::$instance->editor->is_edit_mode() && !$this->checkCookie()) || (!\Elementor\Plugin::$instance->editor->is_edit_mode() && $settings['trigger'] == 'button')) {
            ...
            <div class="dce-popup-container dce-popup-container-<?php echo $this->get_id(); ?> dce-popup-<?php echo $settings['trigger'] . $fullWindow; ?>">
                ...
                <?php if ($settings['background_layer']) { ?>
                    <div id="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>-background" class="animated dce-modal-background-layer<?php if ($settings['background_layer_close']) { ?> dce-modal-background-layer-close<?php } ?> modal-background-layer<?php if (\Elementor\Plugin::$instance->editor->is_edit_mode()) { ?> block-i<?php } ?>" data-dismiss="modal" data-target="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>"></div>
            <?php } ?>

                <div id="dce-popup-<?php echo $this->get_id(); ?>-<?php echo get_the_id(); ?>"
                     class="dce-popup-<?php echo $this->get_id(); ?> dce-modal<?php if ($settings['esc_hide'] && !\Elementor\Plugin::$instance->editor->is_edit_mode()) { ?> modal-hide-esc<?php } ?><?php if ($settings['scroll_hide'] && !\Elementor\Plugin::$instance->editor->is_edit_mode()) { ?> modal-hide-on-scroll<?php } ?> modal-<?php echo $settings['modal_align']; ?> modal-<?php echo $settings['modal_valign']; ?> <?php if (\Elementor\Plugin::$instance->editor->is_edit_mode()) { ?> block-i<?php } ?>"
                     tabindex="-1"
                     role="dialog"
                     >
