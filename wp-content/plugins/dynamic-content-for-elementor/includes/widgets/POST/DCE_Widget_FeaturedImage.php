...
class DCE_Widget_FeaturedImage extends DCE_Widget_Prototype {
    ...
    protected function render() {
        ...
        //
        // ------------------------------------------
        $id_page = DCE_Helper::get_the_id($settings['other_post_source'],$settings['other_post_parent']);
        ...
        if( $featured_img_url != '') {
            ...
            $get_featured_img = '<img src="'.$featured_img_url.'"'.$image_alt.' />'; //get_the_post_thumbnail( $id_page, $image_size, array( 'src'   => $image_url ) ); //
        }
