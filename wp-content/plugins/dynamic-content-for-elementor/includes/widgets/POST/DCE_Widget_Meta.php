...
class DCE_Widget_Meta extends DCE_Widget_Prototype {
    ...
    protected function render() {
        ...
        // ------------------------------------------
        $post_id = $id_page = DCE_Helper::get_the_id();
        ...
        if (!empty($meta_values)) {
            ...
            foreach ($meta_values as $mkey => $meta_value) {
                ...
                if (!$settings['dce_meta_raw']) {
                    $meta_value_enchanted = DCE_Helper::get_post_meta($post_id, $meta_key, true, true, false);
                                ...
                                if ($settings['dce_meta_multiple_tag'] == 'custom') {
                                    ...
                                    if ($settings['dce_meta_multiple_id']) {
                                        ...
                                        if ($avalue) {
                                            ...
                                            /*switch($settings['dce_meta_multiple_id']) {
                                                case 'user':                                                    
                                                    $avalue = get_user_by('id', $avalue);                                                    
                                                    break;
                                                case 'post':
                                                    $avalue = get_post($avalue);
                                                    break;
                                                case 'term':
                                                    $avalue = get_term_by('id', $avalue);
                                                    break;
                                            }*/
                    ...
                    case 'time_picker':
                        ...
                        if ($settings['dce_meta_date_format_source']) {
                            if ($settings['dce_meta_date_format_source'] == 'timestamp') {
                                ...
                                //var_dump($meta_value);
                                if (is_array($meta_value)) { // ACF Repeatert
