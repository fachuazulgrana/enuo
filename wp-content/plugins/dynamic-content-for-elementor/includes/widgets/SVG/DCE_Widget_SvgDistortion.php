...
class DCE_Widget_SvgDistortion extends DCE_Widget_Prototype {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'preserveMode', [
                'label' => __('Ratio mode ', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'slice' => __('Crop', DCE_TEXTDOMAIN),
                    'meet' => __('Keep', DCE_TEXTDOMAIN),
                ],
                'default' => 'slice',
                'condition' => [
                    'preserveAR' => 'yes',
      ...
      $this->add_control(
        ...
        [
            ...
            'description' => __('Use distortion only as for appling to other page elements. Activating this option the svg element will not be displayed.', 'dynamic-content-for-elementor'),
            'type' => Controls_Manager::SWITCHER,
            'default' => '',
    ...
    protected function render() {
        ...
        $filterId = '';
        if( $settings['displacement_image']['url'] ) $filterId = 'filter="url(#distortion-filter-'.$widgetId.')"';
    ...
    protected function _content_template() {
      ...
      //var dispX = settings.disp_x.size;
      //var dispY = settings.disp_y.size;
