...
jQuery(function ($) {
    ...
    $( function() {
        ...
        var $tooltipElements = $( 'body.bp-user:not(.grimlock-buddypress--members-actions-text-displayed) #item-buttons > div > a, body.groups.single-item:not(.grimlock-buddypress--groups-actions-text-displayed) #item-buttons > div > a, body:not(.grimlock-buddypress--groups-actions-text-displayed) .bp-card-list--groups__item div.action > div > a, body:not(.grimlock-buddypress--groups-actions-text-displayed) .bp-card-list--groups__item div.action > a, body:not(.grimlock-buddypress--members-actions-text-displayed) .bp-card-list--members__item div.action > div > a, body:not(.grimlock-buddypress--members-actions-text-displayed) .bp-card-list--members__item div.action > a, #rtmedia-add-media-button-post-update');
