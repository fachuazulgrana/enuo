...
class Grimlock_Login_Customizer extends Grimlock_Base_Customizer {
	...
	public function add_customizer_fields() {
		...
		$this->add_navbar_nav_menu_login_button_display_modal_field( array( 'priority' => 10  ) );
		$this->add_layout_field( array( 'priority' => 20 ) );
		$this->add_custom_logo_field( array( 'priority' => 30 ) );
		$this->add_background_image_field( array( 'priority' => 40 ) );
	}
