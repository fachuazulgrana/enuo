	...
	protected function add_button_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'output'    => $outputs,
				'css_vars'  => array(
					array( '--grimlock-button-font-family', '$', 'font-family' ),
					array( '--grimlock-button-font-weight', '$', 'font-weight' ),
					array( '--grimlock-button-font-size', '$', 'font-size' ),
					array( '--grimlock-button-line-height', '$', 'line-height' ),
					array( '--grimlock-button-letter-spacing', '$', 'letter-spacing' ),
					array( '--grimlock-button-text-transform', '$', 'text-transform' ),
				),
