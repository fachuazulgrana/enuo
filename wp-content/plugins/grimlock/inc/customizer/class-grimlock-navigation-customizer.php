	...
	protected function add_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'css_vars'  => array(
					array( '--grimlock-navigation-font-family', '$', 'font-family' ),
					array( '--grimlock-navigation-font-weight', '$', 'font-weight' ),
					array( '--grimlock-navigation-font-size', '$', 'font-size' ),
					array( '--grimlock-navigation-line-height', '$', 'line-height' ),
					array( '--grimlock-navigation-letter-spacing', '$', 'letter-spacing' ),
					array( '--grimlock-navigation-text-transform', '$', 'text-transform' ),
				),
