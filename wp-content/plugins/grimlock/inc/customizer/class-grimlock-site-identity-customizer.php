	...
	protected function add_blogname_font_field( $args = array() ) {
		if ( class_exists( 'Kirki') ) {
			...
			$args = wp_parse_args( $args, array(
				...
				'output'    => $outputs,
				'css_vars'  => array(
					array( '--grimlock-site-identity-blogname-font-family', '$', 'font-family' ),
					array( '--grimlock-site-identity-blogname-font-weight', '$', 'font-weight' ),
					array( '--grimlock-site-identity-blogname-font-size', '$', 'font-size' ),
					array( '--grimlock-site-identity-blogname-line-height', '$', 'line-height' ),
					array( '--grimlock-site-identity-blogname-letter-spacing', '$', 'letter-spacing' ),
					array( '--grimlock-site-identity-blogname-text-transform', '$', 'text-transform' ),
				),
