...
abstract class Grimlock_Base_Widget_Fields {
	...
	protected function radio_image( $args ) {
		...
		<div class="grimlock_section_widget-radio-image wp-clearfix">
	...
	protected function image( $args ) {
		...
		<div class="grimlock_section_widget-image wp-clearfix">
	...
	protected function range( $args ) {
        ...
        <p>
            <label for="<?php echo $args['id']; ?>"><?php echo $args['label']; ?></label>
            <input class="widefat" id="<?php echo $args['id']; ?>" name="<?php echo $args['name']; ?>" type="range" value="<?php echo esc_attr( $args['value'] ); ?>" <?php echo '' !== $args['min'] ? 'min="' . $args['min'] . '"' : '' ?> <?php echo '' !== $args['max'] ? 'max="' . $args['max'] . '"' : '' ?> <?php echo '' !== $args['step'] ? 'step="' . $args['step'] . '"' : '' ?> />
	        <?php if ( ! empty( $args['description'] ) ) : ?>
                <small style="display: inline-block;"><?php echo $args['description'] ?></small>
	        <?php endif; ?>
        </p>
