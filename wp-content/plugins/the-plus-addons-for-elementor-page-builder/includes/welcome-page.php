				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">OCT 05,2020 <span class="changelog-version">Lite Version 2.0.0</span></div>';
						echo '<ul class="changelog-list">';
							...
							echo '<li>'.esc_html__('Updated & Included 30+ Widgets','tpebl').'</li>';
							echo '<li>'.esc_html__('Added 3+ New Features','tpebl').'</li>';
							echo '<li>'.esc_html__('Compatibility with WordPress 5.5','tpebl').'</li>';
							echo '<li>'.esc_html__('Compatibility with Elementor 3.X','tpebl').'</li>';
