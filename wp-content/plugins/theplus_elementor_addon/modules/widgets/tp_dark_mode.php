...
class ThePlus_Dark_Mode extends Widget_Base {
    ...
    protected function _register_controls() {
	 ...
	 protected function render() {
		...
		echo '<div class="tp-dark-mode-wrapper" data-time="0.'.$dm_time.'s" data-dm_mixcolor="#fff" data-bgcolor="'.$dm_backgroundcolor.'" data-save-cookies="'.$dm_save_in_cookies.'" data-auto-match-os-theme="'.$dm_auto_match_os_theme.'" data-style="'.$dm_style.'">';
		...
		jQuery(document).ready(function() {
			...
			jQuery( "'.$settings['dm_ignore'].'" ).addClass( "theplus-darkmode-ignore" );
		});</script>';
		}
		/*append class end*/
