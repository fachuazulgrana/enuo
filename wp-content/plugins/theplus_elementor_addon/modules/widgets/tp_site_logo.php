		...
		if($logo_type=='image'){
			...
			if($settings["image_logo"]["url"]!=''){				
				...
				$normal_logo = '<a href="'.esc_url($logo_url).'" ' . $target . $nofollow . ' title="'.esc_attr(get_bloginfo()).'" class="site-normal-logo image-logo" >';
					$normal_logo .= '<img src="'.esc_url($logo_image).'" class="image-logo-wrap normal-image '.$stcky_cls.'" alt="'.esc_attr(get_bloginfo()).'">';
			...
			if($settings["svg_logo"]["url"]!=''){
				...
				$normal_logo ='<a href="'.esc_url($logo_url).'" ' . $target . $nofollow . ' title="'.esc_attr(get_bloginfo()).'" class="site-normal-logo svg-logo">';
					$normal_logo .='<img class="image-logo-wrap normal-image  '.$stcky_cls.'" src="'.esc_url($logo_svg).'" alt="'.esc_attr(get_bloginfo()).'" />';
