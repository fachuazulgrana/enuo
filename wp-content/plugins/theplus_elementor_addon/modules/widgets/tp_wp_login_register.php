...
class ThePlus_Wp_Login_Register extends Widget_Base {
    ...
    protected function _register_controls() {	
		...
		$this->add_control(
			'pattern_desc_1',
			[
				'label' => esc_html__( 'Minimum eight characters, at least one letter, one number and one special character', 'theplus' ),
		...
		$this->add_control(
			'pattern_desc_2',
			[
				'label' => esc_html__( 'Minimum four and Maximum eight characters, at least one numeric digit', 'theplus' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'condition' => [
					'tp_dis_pass_field' => 'yes',
					'tp_dis_pass_field_strong' => 'yes',
		...
		$this->add_control(
			'pattern_desc_3',
			[
				'label' => esc_html__( 'Minimum six characters, at least one letter and one number', 'theplus' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'condition' => [
					'tp_dis_pass_field' => 'yes',
					'tp_dis_pass_field_strong' => 'yes',
		...
		$this->add_control(
			'pattern_desc_4',
			[
				'label' => esc_html__( 'Minimum eight characters long. - At least one uppercase, one lowercase, one digit OR one 1 alphanumeric', 'theplus' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'condition' => [
					'tp_dis_pass_field' => 'yes',
					'tp_dis_pass_field_strong' => 'yes',
		...
		$this->add_control(
			'pattern_desc_5',
			[
				'label' => esc_html__( 'Minimum eight characters long. - At least one capital letter, one lowercase, one number OR special character', 'theplus' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'condition' => [
					'tp_dis_pass_field' => 'yes',
					'tp_dis_pass_field_strong' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Custom Validation Option', 'theplus' ),	
				'condition' => [
					'form_selection' => ['tp_register','tp_login_register'],
				],
			]
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Email', 'theplus' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Enter Email', 'theplus' ),
				'condition' => [
					'cst_validation_switch' => 'yes',
				],
			]
		...
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__('Custom Validation Styling', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'form_selection' => ['tp_register','tp_login_register'],
					'cst_validation_switch' => 'yes',
	...
	public function user_register_form() {
		...
		<form id="tp-user-register<?php echo esc_attr($id); ?>" name="tp-user-registration" class="tp-form-stacked " method="post" action="" data-dis_cap="<?php echo $dis_cap; ?>" data-dis_password="<?php echo $dis_password; ?>" data-after_reg_redirect="<?php echo $redirect_url_reg; ?>" data-dis_mail_chimp="<?php echo $dis_mail_chimp; ?>" data-mc_custom_apikey="<?php echo $mc_custom_apikey; ?>" data-mc_custom_listid="<?php echo $mc_custom_listid; ?>" data-tp_user_reg_role="<?php echo $tp_user_reg_role; ?>">
			...
			<div class="tp-field-group tp-lr-f-user-pass">
				...
				echo '<input type="password" name="user_password" id="user_password'.esc_attr($id).'" placeholder="'.$settings['r_password_placeholder'].'" class="tp-input tp-reg-f-load" required '.$pattern_pass_reg.'>';
			...
			if(!empty($settings['tp_dis_pass_meter']) && $settings['tp_dis_pass_meter']=='yes'){
				...
				jQuery( document ).ready( function( $ ) {
					...
					$( 'body' ).on( 'keyup', 'form#tp-user-register<?php echo esc_attr($id); ?> input[name=user_password],form#tp-user-register<?php echo esc_attr($id); ?> input[name=user_conf_password]', function( event ) {
						wdmChkPwdStrength(
