...
if ( ! defined( 'GWANGI_LEARNDASH_LAYOUT' ) ) {
	define( 'GWANGI_LEARNDASH_LAYOUT', '12-cols-left' );
}

if ( ! defined( 'GWANGI_LEARNDASH_CONTAINER_LAYOUT' ) ) {
	define( 'GWANGI_LEARNDASH_CONTAINER_LAYOUT', 'classic' );
}

if ( ! defined( 'GWANGI_LEARNDASH_CUSTOM_HEADER_LAYOUT' ) ) {
	define( 'GWANGI_LEARNDASH_CUSTOM_HEADER_LAYOUT', '12-cols-left' );
}

if ( ! defined( 'GWANGI_LEARNDASH_CUSTOM_HEADER_CONTAINER_LAYOUT' ) ) {
	define( 'GWANGI_LEARNDASH_CUSTOM_HEADER_CONTAINER_LAYOUT', 'classic' );
}
